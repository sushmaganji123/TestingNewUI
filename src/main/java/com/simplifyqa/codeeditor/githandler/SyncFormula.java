...
public class SyncFormula {
    private static final String endPoint = "http://localhost:4040/sync/formula/codeeditor";
    ...
    private static final Logger log = Logger.getLogger(SyncFormula.class.getName());
    ...
    public static int sendRequest(String requestBody) {
        ...
        try {
            ...
            log.info(ANSI_YELLOW
                    + ":::::::::::::::::::::::::::::::::::SENDING FORMULA SYNC REQUEST TO AGENT:::::::::::::::::::::::::::::::::::"
                    + ANSI_RESET);
            ...
            if (responseBody == null) {
                log.info("::::::::::::::::::::::::::::::::::" + ANSI_YELLOW + " NO CUSTOM FORMULAS TO SYNC!!" + ANSI_RESET
                        + " ::::::::::::::::::::::::::::::::::");
                System.out.println();
            ...
            if (responseBody.isSaved()) {
                log.info("::::::::::::::::::::::::::::::::::" + ANSI_GREEN + " SUCCESSFULLY SYNCED CUSTOM FORMULAS" + ANSI_RESET
                        + " ::::::::::::::::::::::::::::::::::");
                System.out.println();
                printMessage(responseBody);
                return SUCCESS;
                ...
                log.log(Level.SEVERE,
                        ANSI_RED + "COULD NOT SYNC CUSTOM FORMULAS: " + ANSI_YELLOW + responseBody.getErrors() + ANSI_RESET);
                System.out.println();
                printMessage(responseBody);
                return ERROR;
            }
    ...
    private static void printMessage(SyncResponse syncResponse) {
        if (syncResponse != null && syncResponse.getMessage() != null) {
            log.info("MESSAGE: " + ANSI_GREEN + syncResponse.getMessage() + ANSI_RESET);
        }
    }
    ...
    private static SyncResponse parseResponse(String jsonResponse) {
        ...
        try {
            ...
            String message = extractField(jsonResponse, "message");

            return new SyncResponse(pending, saved, errors, message);
        } catch (Exception e) {
            printGap();
            printGap();
